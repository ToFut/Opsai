...
-- CreateIndex
CREATE UNIQUE INDEX "sessions_userId_tenantId_key" ON "sessions"("userId", "tenantId");
...
-- AddForeignKey
ALTER TABLE "sync_jobs" ADD CONSTRAINT "sync_jobs_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "integrations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
