...
import { ServiceConfig, DatabaseConfig, AuthConfig, IntegrationConfig } from '../config/service-config';
...
export class ServiceResolver {
   ...
   */
  private getCoreIntegrationCredentials(integrationName: string): Record<string, string> {
   ...
   */
  resolveTemporalConfig(): { host: string; namespace: string } {
    if (this.config.mode === 'shared') {
      return {
